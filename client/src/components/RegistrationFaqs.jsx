        ...
        <div className='-mx-4 flex flex-wrap'>
          <div className='w-full px-4 lg:w-1/2'>
            ...
            <AccordionItem
              ...
              text='Yes, starting May 1 2024, if you are a US citizen or alien resident and happen to pass away while visiting Cameroon for a period of six months or less, you can benefit from SAGI.'
            />
          </div>
          <div className='w-full px-4 lg:w-1/2'>
            <AccordionItem
            ...
            <AccordionItem
              ...
              text='Anyone willing to abide by SAGI Rules.'
            />
            <AccordionItem
